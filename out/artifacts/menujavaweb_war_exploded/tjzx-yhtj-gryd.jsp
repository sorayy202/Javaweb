...
<c:choose>
    <c:when test="${order.size() == 0}">
        <div style="margin: 80px auto;display: flex;justify-content: center;flex-wrap: wrap">
            ...
            <p style="width: 100%;text-align: center;color: #8a8a8a">这个月还没有订餐记录喔~   <a href="${pageContext.request.contextPath}/UsertjServlet"><button class="btn" >返回</button></a></p>
        </div>
    </c:when>
    <c:otherwise>
        <div id="main"  style="margin: 30px 50px;">
            ...
            <div style="width: 100%;display: flex;flex-direction: row;border: 1px solid black">
                <div style="width: 50%;padding-left: 20px;margin-top: 10px;margin-bottom: 10px">操作员:${operator}</div>
        ...
        <div id="anniu" style="width: 100%;display: flex;justify-content: center">
            <a href="${pageContext.request.contextPath}/UsertjServlet"><button class="btn" >返回</button></a>
